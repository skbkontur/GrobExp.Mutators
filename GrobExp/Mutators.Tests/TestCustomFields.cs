...
namespace Mutators.Tests
{
    ...
    public class TestCustomFields
    {
        ...
        public void TestWebDataValidator()
        {
            ...
            var dataConfiguratorCollection = new TestDataConfiguratorCollection<Data>(dataConfiguratorCollectionFactory, converterCollectionFactory, pathFormatterCollection, configurator =>
                {
        ...
        public void TestModelDataMutator()
        {
            ...
            var modelData = new ModelData {CustomFields = new CustomFieldsContainer {{"X", new CustomFieldValue(converter){Value = 0}}, {"Y", new CustomFieldValue(converter){Value = 1}}, {"Z", new CustomFieldValue(converter){Value = 2}}}};
